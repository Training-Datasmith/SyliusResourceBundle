...
final class Operations implements \IteratorAggregate, \Countable
{
    ...
    public function __construct(array $operations = [])
    {
        foreach ($operations as $operation_name => $operation) {
            $this->operations[] = [$operation_name, $operation];
        }
    }
    /**
    ...
    public function getIterator(): \Traversable
    {
        return (function (): \Generator {
            foreach ($this->operations as [$operation_name, $operation]) {
                yield $operation_name => $operation;
            }
        })();
    }
    ...
    {
        foreach ($this->operations as $i => [$operation_name, $operation]) {
            if ($operation_name === $key) {
