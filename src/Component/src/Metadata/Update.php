...
final class Update extends Http_Operation implements Update_Operation_Interface, State_Machine_Aware_Operation_Interface
{
    ...
    {
        parent::__construct(methods: $methods ?? ['GET', 'PUT', 'POST'], path: $path, routeName: $route_name, routePrefix: $route_prefix, routeRequirements: $route_requirements, routeCondition: $route_condition, routePriority: $route_priority, template: $template, shortName: $short_name ?? 'update', name: $name, provider: $provider, processor: $processor, responder: $responder, repository: $repository, repositoryMethod: $repository_method, repositoryArguments: $repository_arguments, read: $read, write: $write, validate: $validate, deserialize: $deserialize, serialize: $serialize, formType: $form_type, formOptions: $form_options, validationContext: $validation_context, eventShortName: $event_short_name, notificationMessage: $notification_message, security: $security, securityMessage: $security_message, twigContextFactory: $twig_context_factory, redirectTo: $redirect_to, redirectToRoute: $redirect_to_route, redirectArguments: $redirect_arguments, vars: $vars);
    }
