...
{
    private readonly RepositoryFactory $doctrineFactory;
     ...
     */
    public function __construct(RepositoryFactory $doctrineFactory, private readonly array $genericEntities)
    {
