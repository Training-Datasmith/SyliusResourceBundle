...
use Sylius\Bundle\Resource_Bundle\Validator\Constraints\Enabled;
use Sylius\Resource\Model\Toggleable_Interface;
use Symfony\Component\Validator\Constraint;
use Symfony\Component\Validator\Constraint_Validator;
use Webmozart\Assert\Assert;
final class Enabled_Validator extends Constraint_Validator
{
    public function validate(mixed $value, Constraint $constraint): void
    {
        Assert::is_instance_of($constraint, Enabled::class);
        if (null === $value) {
            return;
        }
